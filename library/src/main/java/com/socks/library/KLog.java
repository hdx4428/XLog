...
public final class KLog {
    ...
    private static final String SUFFIX_KOTLIN = ".kt";
    ...
    private  static  boolean IS_SHOW_METHOD_NAME =false;  //是否打印方法名 , 默认不显示
    ...
    public static void init(boolean isShowLog, @Nullable String tag,boolean isShowMethodName) {
        IS_SHOW_LOG = isShowLog;
        mGlobalTag = tag;
        mIsGlobalTagEmpty = TextUtils.isEmpty(mGlobalTag);
        IS_SHOW_METHOD_NAME = isShowMethodName;
    }
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        //  通过文件名获取后缀, 若是java,则返回 .java  ,  若是 kotlin ,则返回 .kt
        ...
        String methodName =IS_SHOW_METHOD_NAME? targetElement.getMethodName():"";
